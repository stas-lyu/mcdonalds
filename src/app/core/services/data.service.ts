        ...
        "products": [
          {
            ...
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-oreo-mcflurry-snack.jpg?$Product_Desktop$",
            price: 1.99,
            size: ["R", "SN"],
            cal: 510,
            description: "The McDonald’s McFlurry® with OREO® Cookies is an popular combination of OREO® pieces and vanilla soft serve! Available in Regular Size and Snack Size on the McDonald's Desserts & Shakes menu."
          },
          {
            id: 1,
        ...
        "products": [
          {
            ...
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-fries-small.jpg?$Product_Desktop$",
            price: 1.99,
            size: ["S", "M", "L"],
            cal: 220,
          ...
          },
          {
            id: 1,
            name: "Apple Slices",
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-Apple-Slices.jpg?$Product_Desktop$",
            price: 1.99,
            size: ["default"],
            ingredients: ["English Muffin", "Egg", "Canadian Bacon", "Pasteurized Process American Cheese", "Salted Butter", "Clarified Butter"],
            cal: 15,
        ...
        "products": [
          {
            id: 0,
            name: "Big Mac®",
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-Big-Mac.jpg?$Product_Desktop$",
            price: 19.99,
            ingredients: ["Big Mac Bun", "100% Beef Patty", "Shredded Lettuce", "Big Mac Sauce", "Pasteurized Process American Cheese", "Pickle Slices"],
            size: ["default"],
            cal: 550,
            description: "Mouthwatering perfection starts with two 100% pure beef patties and Big Mac® sauce sandwiched between a sesame seed bun. It’s topped off with pickles, crisp shredded lettuce, finely chopped onion and American cheese for a 100% beef burger with a taste like no other. It contains no artificial flavors, preservatives or added colors from artificial sources.* Our pickle contains an artificial preservative, so skip it if you like. There are 550 calories in a Big Mac®. Order one today with McDelivery®!"
          },
          {
            id: 1,
            name: "Hamburger",
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-Hamburger.jpg?$Product_Desktop$",
            price: 1.99,
            size: ["default"],
            ingredients: ["Regular Bun", "100% Beef Patty", "Ketchup", "Pickle Slices", "Onions", "Mustard"],
            cal: 250,
            description: "The original burger starts with a 100% pure beef burger seasoned with just a pinch of salt and pepper. Then, the McDonald’s burger is topped with a tangy pickle, chopped onions, ketchup and mustard. McDonald’s hamburger contains no artificial flavors, preservatives or added colors from artificial sources.* Our pickle contains an artificial preservative, so skip it if you like."
          },
          {
            id: 2,
            name: "Cheeseburger",
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-Cheeseburger.jpg?$Product_Desktop$",
            price: 1.99,
            size: ["default"],
            cal: 300,
            description: "MOur simple, classic cheeseburger begins with a 100% pure beef burger seasoned with just a pinch of salt and pepper. The McDonald’s Cheeseburger is topped with a tangy pickle, chopped onions, ketchup, mustard, and a slice of melty American cheese. It contains no artificial flavors, preservatives or added colors from artificial sources.* Our pickle contains an artificial preservative, so skip it if you like. For more delicious burger variations explore the McDonald’s burger menu."
          },
          {
            id: 3,
            name: "Quarter Pounder®* with Cheese",
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-Quarter-Pounder-with-Cheese.jpg?$Product_Desktop$",
            price: 2.40,
            size: ["default"],
            ingredients: ["Quarter Pound 100% Beef Patty*", "Quarter Pound Bun", "Pasteurized Process American Cheese", "Ketchup", "Pickle Slices", "Onions"],
            cal: 520,
        ...
        "products": [
          {
            ...
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-spicy-deluxe-crispy-chicken-sandwich.jpg?$Product_Desktop$",
            price: 8.40,
            ingredients: ["Crispy Chicken Fillet", "Potato Roll", "Roma Tomato", "Spicy Pepper Sauce", "Shredded Lettuce"],
            size: ["default"],
            cal: 540,
          ...
          },
          {
            id: 1,
            name: "McChicken®",
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-McChicken.jpg?$Product_Desktop$",
            price: 1.99,
            ingredients: ["McChicken Patty", "Regular Bun", "Shredded Lettuce", "Mayonnaise"],
            size: ["default"],
            cal: 400,
            description: "It’s a classic for a reason. Savor the satisfying crunch of our juicy chicken patty, topped with shredded lettuce and just the right amount of creamy mayonnaise, all served on a perfectly toasted bun.* The McChicken® has 400 calories. Get your McChicken® at the drive thru or with McDonald's Curbside pickup when you Mobile Order & Pay! McDonald's App download and registration required."
          },
          {
            id: 2,
            name: "Crispy Chicken Sandwich",
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-crispy-chicken-sandwich.jpg?$Product_Desktop$",
            price: 1.99,
            ingredients: ["Crispy Chicken Fillet", "Potato Roll", "Crinkle Cut Pickle", "Salted Butter"],
            size: ["default"],
            cal: 530,
            description: "McDonald's Crispy Chicken Sandwich is a southern style fried chicken sandwich that's crispy, juicy and tender perfection. It’s topped with crinkle-cut pickles and served on a toasted, buttered potato roll. The Crispy Chicken sandwich has 470 calories. Check out all the Crispy Chicken Sandwiches. Order one today in the McDonald’s app."
          },
          {
            id: 3,
          ...
          },
          {
            ...
            imgUrl: "https://www.mcdonalds.com/is/image/content/dam/usa/nfl/nutrition/items/hero/desktop/t-mcdonalds-deluxe-crispy-chicken-sandwich.jpg?$Product_Desktop$",
            price: 8.40,
            ingredients: ["Crispy Chicken Fillet", "Potato Roll", "Roma Tomato", "Mayonnaise", "Shredded Lettuce"],
            size: ["default"],
            cal: 530,
            description: "Get a little extra with toppings. Go deluxe with shredded lettuce, Roma tomatoes and mayo to take crispy, juicy and tender to the next level. The Deluxe Crispy Chicken sandwich has 530 calories. Check out all the Crispy Chicken Sandwiches. Order one today in the McDonald’s app."
          },
        ]
      }
    ]
